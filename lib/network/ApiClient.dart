class ApiClient {
  ...
  static final String webUrlConcept2 =
      'https://log.concept2.com/oauth/authorize?client_id=lml0j3pwEih2egPLFoBNuOcoJkY4yFR3CB5Olrrd%20&scope=user:read,results:read&response_type=code&redirect_uri=http://api.myosport.co/authenticated';
...
//Api for Sending Equipment Feedback
  ...
  static final String urlGetNotifications =
      baseUrl + 'api/user/v1/notifications/';
  ...
  static final String urlGetWorkoutStats =
      baseUrl + 'api/workout/v1/view-stats';
  static final String urlUpdateProfile = baseUrl + 'api/user/v1/update/profile';
  static final String urlGetCoachWorkouts =
      baseUrl + 'api/club/v1/coach/athletes';
  static final String urlGetCoachAthletes =
      baseUrl + 'api/club/v1/coach/players';
  ...
  static final String urlGetWorkoutActivities =
      baseUrl + 'api/workout/v1/details';
  static final String urlGetWorkoutsActivities =
      baseUrl + 'api/workout/v1/details-updated';
  ...
  static final String urlResetPassword =
      baseUrl + 'api/user/v1/password/update';
  ...
  static final String urlSendVerificationCode =
      baseUrl + 'api/user/v1/email-verification';

  //Equipment Reservation
  static final String urlGetCategories =
      baseUrl + 'api/equipments/category-view';
  static final String urlGetEquipments =
      baseUrl + 'api/equipments/equipment-view-by-category';
  static final String urlGetTimeSlots =
      baseUrl + 'api/equipments/equipment-slots';
  static final String urlGetQuantity =
      baseUrl + 'api/equipments/min-quantity-available';
  static final String urlGetQuantityRange =
      baseUrl + 'api/equipments/min-quantity-available-range';
  static final String urlReserveSlot = baseUrl + 'api/equipments/slot-reserve';
  static final String urlReserveDate =
      baseUrl + 'api/equipments/reserve-for-days';
  static final String urlReserveDateRange =
      baseUrl + 'api/equipments/reserve-for-multiple-days';
  static final String urlGetReservedList =
      baseUrl + 'api/equipments/user-reservations';
  static final String urlCancelReservation =
      baseUrl + 'api/equipments/slot-cancel-reservation';
  ...
  //Concept2
  static final String urlSaveC2Email =
      baseUrl + 'api/workout/v1/concept2/save-email';
  static final String urlCheckEmail =
      baseUrl + 'api/workout/v1/concept2/save-check';

  //Club Search
  static final String urlGetSearchedAllClub =
      baseUrl + 'api/user/v1/club-search/';
  static final String urlGetSearchedAssignedClub =
      baseUrl + 'api/user/v1/club-search-assigned/';
}
