...
class MyClubFeed extends StatefulWidget {
  ...
  @override
  _MyClubFeedState createState() => _MyClubFeedState();
}

class _MyClubFeedState extends State<MyClubFeed> {
  bool isLoading = true;
                          ...
                          itemBuilder: (context, index) {
                            if (index == feeds.length) {
                              ...
                              return FeedWidget(
                                feed: feed,
                                userId: userId,
                                isAdmin: widget.isAdmin || widget.isModerator,
                                onRefresh: (){
                                  setState(() {
                                    isLoading = true;
                                    skip=0;
  ...
  getClubsFeed(int skip) async {
    ...
    String apiUrl = ApiClient.urlGetClubFeeds;
