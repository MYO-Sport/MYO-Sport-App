...
import 'package:us_rowing/network/body/TeamMessageModel.dart';
...
class TeamChatScreen extends StatefulWidget {
  ...
  @override
  State createState() => new _TeamChatScreenState();
}
...
class _TeamChatScreenState extends State<TeamChatScreen> {
  ...
  void initState() {
    ...
    widget.socket.on('team-message', (data) {
  ...
  getChatList() {
    widget.socket.emit('view-team-chat', widget.teamId);
    widget.socket.on('view-team-chat', (data) {
      print(data);
  ...
  sendMessage() {
    ...
    print('Message Sent');
    TeamMessageModel message = TeamMessageModel(
        body: text,
    ...
    print('teamId: ' + message.teamId);
    if (this.mounted) {
      setState(() {
        listMessage.insert(0, message1);
      });
    }
    widget.socket.emit('team-message', message);
  }
