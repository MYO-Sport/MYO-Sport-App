...
class EquipmentDetailView extends StatefulWidget {
  ...
  EquipmentDetailView({required this.equipment,required this.clubId, required this.userId});
...
class _EquipmentDetailViewState extends State<EquipmentDetailView> {
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: CachedImage(
                      image: ApiClient.baseUrl+widget.equipment.equipmentImage,
                      radius: 0,
                      padding: 0,
                      fit: BoxFit.fill,
                      imageHeight: 180,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Radio(value: selectedType, groupValue: 0, onChanged: (value){
                              setState(() {
                                selectedType = 0;
                              });
                              getSlots();
                        ...
                        Row(
                          children: [
                            Radio(value: selectedType, groupValue: 1, onChanged: (value){
                              setState(() {
                                selectedType = 1;
                              });
                              getQuantity();
                        ...
                        Row(
                          children: [
                            Radio(value: selectedType, groupValue: 2, onChanged: (value){
                              setState(() {
                                selectedType = 2;
                              });
                              getRangeQuantity();
                    ...
                    Column(
                      ...
                      children: [
                        selected==-1?
                        Text('Select a time slot by date.',style: TextStyle(color: colorBlack,fontSize: 16),):
                        Column(
                          children: [
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  ...
                                  children: [
                                    InkWell(
                                      child: Container(
                                        ...
                                        child: Center(child: Text('-',style: TextStyle(color: colorGrey,fontSize: 18),),),),
                                      onTap: decreement,
                                    ),
                                    SizedBox(width: 10,),
                                    SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text('$quantity',style: TextStyle(color: colorPrimary,fontSize: 18),),
                                            Text('/$availableQuantity',style: TextStyle(color: colorGrey,fontSize: 12),),
                                          ],
                                        )),
                                    SizedBox(width: 10,),
                                    InkWell(
                                        child: Container(
                                          ...
                                          child: Center(child: Icon(Icons.add,color: colorGrey,size: 12,),),),
                                        onTap: increment
                                    ),
                                  ],
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(strDate,style: TextStyle(color: colorPrimary,fontSize: 14),),
                                SizedBox(width: 10,),
                                InkWell(child: Icon(Icons.arrow_drop_down,color: colorGrey),
                                  onTap: () async {
                        ...
                        slots.length==0?
                        Container(margin: EdgeInsets.symmetric(vertical: 20),child: Center(child: Text('No Time Slots Found at this date',style: TextStyle(color: colorGrey,fontSize: 12),),)):
                        GridView.builder(
                          ...
                          itemBuilder:
                            ...
                            return InkWell(child: SlotWidget(slot: slot,index: index,selected: selected,),onTap: (){
                              if(slot.status=='0'){
                                setState(() {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(strStartDate + '-' + strEndDate,style: TextStyle(color: colorPrimary,fontSize: 14),),
                                    SizedBox(width: 10,),
                                    InkWell(child: Icon(Icons.arrow_drop_down,color: colorGrey),
                                      onTap: () async {
                                        // DateTime? date = DateTime(1900);
  ...
  getSlots() async {
    ...
    String mDate='${selectedDate.year}-${selectedDate.month}-${selectedDate.day}';
  ...
  reserveSlot() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (mResponse.status) {
        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>CompleteView()));
