...
import 'package:us_rowing/network/body/UsMessageBody.dart';
...
class UsChatScreen extends StatefulWidget {
  ...
  @override
  State createState() => new _UsChatScreenState();
}

class _UsChatScreenState extends State<UsChatScreen> {
  ...
  void initState() {
    ...
    widget.socket.on('us-rowing-chat', (data) {
...
/*   static bool isLastMessageRight(var listMessage, String id, int index) {
 ...
 /*  static bool isLastMessageLeft(var listMessage, String id, int index) {
  ...
  getChatList() {
    widget.socket.emit('view-us-rowing-chat');
    widget.socket.on('view-us-rowing-chat', (data) {
      print(data);
  ...
  sendMessage() {
    ...
    print('Message Sent');
    UsMessageBody message = UsMessageBody(
        body: text,
    ...
    widget.socket.emit('us-rowing-chat', message);
  }
